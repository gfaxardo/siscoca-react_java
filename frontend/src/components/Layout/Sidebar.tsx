import { BarChart3, Zap, TrendingUp, FileText, Settings, Plus, Upload, X } from 'lucide-react';
        ...
        <div className="h-full flex flex-col p-6">
          ...
          <nav className="flex-1 space-y-1 overflow-y-auto">
            ...
            <div className="mt-6 pt-6 border-t border-white/10">
              <p className="text-xs font-bold text-gray-300 uppercase tracking-wider mb-4 px-3 flex items-center gap-2">
                <Zap className="w-3.5 h-3.5" style={{ color: '#ef0000' }} />
                Acciones Rápidas
              </p>
